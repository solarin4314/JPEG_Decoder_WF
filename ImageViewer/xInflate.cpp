...
void SetOutBuffer(struct XInflate* inflate, unsigned char* outBuf, int outBufLen)
{
	...
	if(inflate->m_isExternalOutBuffer==FALSE)
	{
		//free(inflate->m_outBuffer);
	}
	...
	if(outBuf)
	{
		...
		inflate->m_isExternalOutBuffer = TRUE;
	}
	else
	{
		...
		inflate->m_outBufferPos = 0;
		inflate->m_isExternalOutBuffer = FALSE;
	}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL CreateCodes(struct XInflate* inflate, unsigned char* lengths, int numSymbols, int* codes)
{
	int		bits;
	int		code = 0;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL CreateTable(struct XInflate* inflate, unsigned char* lengths, int numSymbols, struct XFastHuffTable** pTable, enum XINFLATE_ERR err)
{
...
BOOL _CreateTable(struct XInflate* inflate, int* codes, unsigned char* lengths, int numSymbols, struct XFastHuffTable** pTable)
{
	int		bitLenCount[MAX_CODELEN+1];
	int		symbol;
	int		bitLen;
